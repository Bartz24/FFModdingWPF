...
{
    private readonly int treasureOffset, treasureCount;
    private readonly string ebpPath;
    ...
    public override byte[] Data => header.Concat(TreasureList.Data).Concat(footer);

...
namespace FF13Rando
{
    public class FF13AssumedItemPlacementAlgorithm : AssumedItemPlacementAlgorithm<ItemLocation>
    {
        ...
        public FF13AssumedItemPlacementAlgorithm(Dictionary<string, ItemLocation> itemLocations, List<string> hintsByLocations, RandomizerManager randomizers, int maxFail) : base(itemLocations, hintsByLocations, maxFail)
        {

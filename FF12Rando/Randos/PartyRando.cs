...
namespace FF12Rando
{
    ...
    {
        public DataStoreBPSection<DataStorePartyMember> party = new DataStoreBPSection<DataStorePartyMember>();
        ...
        {
            Randomizers.SetProgressFunc("Loading Party Data...", 0, -1);
            ...
            static void ReplaceGambits(DataStorePartyMember c)
            {
                ...
                {
                    if (itemIDs[i] >= 0x6000 && itemIDs[i] < 0x7000)
                        itemIDs[i] = 0x2000;
                }
                c.ItemIDs = itemIDs;
        ...
        {
            Randomizers.SetProgressFunc("Randomizing Party Data...", 0, -1);
        ...
        public override void Save()
        {
            ...
            Randomizers.SetProgressFunc("Saving Party Data...", 0, -1);

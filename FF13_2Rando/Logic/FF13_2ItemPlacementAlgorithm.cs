...
namespace FF13_2Rando
{
    public class FF13_2ItemPlacementAlgorithm : ItemPlacementAlgorithm<FF13_2ItemLocation>
    {
        ...
        public FF13_2ItemPlacementAlgorithm(Dictionary<string, FF13_2ItemLocation> itemLocations, List<string> hintsByLocations, RandomizerManager randomizers) : base(itemLocations, hintsByLocations)
        {

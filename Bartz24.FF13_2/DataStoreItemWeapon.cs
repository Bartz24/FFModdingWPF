...
public class DataStoreItemWeapon : DataStoreDB3SubEntry
{
    ...
    public int u14DisasRate1 { get; set; }
    public int u14DisasRate2 { get; set; }
    public int u14DisasRate3 { get; set; }
    public int u14DisasRate4 { get; set; }
    public int u14DisasRate5 { get; set; }
}

...
namespace Bartz24.FF13_2
{
    public class DataStoreBtScene : DataStoreDB3SubEntry
    {
        ...
        public override Dictionary<string, int> GetStringArrayMapping()
        {
            ...
            mapping.Add(nameof(s8EntryBtChSpec5_pointer), 2);
            mapping.Add(nameof(s10PartyEntryId_pointer), 3);
            mapping.Add(nameof(s10BtChEntryId_pointer), 4);
            mapping.Add(nameof(s10EntryBtChSpec2_pointer), 5);
            mapping.Add(nameof(s10EntryBtChSpec3_pointer), 6);
            mapping.Add(nameof(s10EntryBtChSpec4_pointer), 7);
